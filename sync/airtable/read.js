...
const MANIFEST_PATH = "airtable-manifest.json";
...
function readFromFallback() {
  const filePath = path.join(process.cwd(), "sync", "airtable", "fallback.json");
...
export async function getManifest() {
  ...
  try {
    ...
    console.error(
      "[sync/airtable/read] Blob read failed, using fallback.json:",
      err.message
    );
